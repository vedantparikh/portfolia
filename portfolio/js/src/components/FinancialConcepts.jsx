...
const FinancialConcepts = () => {
  ...
  const concepts = [
    // Core Performance Metrics
    {
      ...
      example: "Bought 100 shares at $50 + $10 commission = $5,010 cost basis",
    },
    {
    ...
    // Risk Metrics
    {
      ...
      formula: "σ = √(Σ(Ri - R̄)² / n)",
      example: "30% annualized volatility is much riskier than 10% volatility",
    },
    {
      name: "Sharpe Ratio",
      category: "risk",
    ...
    },
    {
      ...
      interpretation: {
        ...
        decision: "Monitor drift and rebalance when it exceeds your threshold",
      },
    ...
    },
    {
      ...
      category: "transactions",
      icon: TrendingDown,
      description: "Sale of assets that decreases your position in a security.",
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              >
                {
                  categories.find((cat) => cat.value === concept.category)
                    ?.label
                }
              </span>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-100 mb-4 flex items-center justify-center">
            <BookOpen className="w-10 h-10 mr-3 text-primary-400" />
            Financial Concepts Guide
          </h1>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Comprehensive guide to financial metrics, calculations, and concepts
            used in portfolio management. Learn what each metric means, how to
            calculate it, and how to use it in your investment decisions.
          </p>
        </div>
